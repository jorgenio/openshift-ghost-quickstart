...
define('ghost-admin/tests/acceptance/editor-test', ['exports', 'mocha', 'chai', 'ghost-admin/tests/helpers/start-app', 'ghost-admin/tests/helpers/destroy-app', 'ghost-admin/tests/helpers/ember-simple-auth', 'ember-cli-mirage', 'sinon', 'ember-test-selectors', 'ghost-admin/tests/helpers/editor-helpers', 'moment'], function (exports, _mocha, _chai, _ghostAdminTestsHelpersStartApp, _ghostAdminTestsHelpersDestroyApp, _ghostAdminTestsHelpersEmberSimpleAuth, _emberCliMirage, _sinon, _emberTestSelectors, _ghostAdminTestsHelpersEditorHelpers, _moment) {
    ...
    (0, _mocha.describe)('Acceptance: Editor', function () {
        ...
        (0, _mocha.describe)('when logged in', function () {
            ...
            (0, _mocha.it)('renders the editor correctly, PSM Publish Date and Save Button', function () {
                ...
                var futureTime = (0, _moment['default'])().tz('Etc/UTC').add(10, 'minutes');
                ...
                click((0, _emberTestSelectors['default'])('psm-trigger'));

                // should error, if the publish time is in the wrong format
                fillIn((0, _emberTestSelectors['default'])('date-time-picker-time-input'), 'foo');
                triggerEvent((0, _emberTestSelectors['default'])('date-time-picker-time-input'), 'blur');
                ...
                fillIn((0, _emberTestSelectors['default'])('date-time-picker-time-input'), futureTime.format('HH:mm'));
                triggerEvent((0, _emberTestSelectors['default'])('date-time-picker-time-input'), 'blur');
                datepickerSelect((0, _emberTestSelectors['default'])('date-time-picker-datepicker'), futureTime);
                ...
                var validTime = (0, _moment['default'])('2017-04-09 12:00');
                fillIn((0, _emberTestSelectors['default'])('date-time-picker-time-input'), validTime.format('HH:mm'));
                triggerEvent((0, _emberTestSelectors['default'])('date-time-picker-time-input'), 'blur');
                datepickerSelect((0, _emberTestSelectors['default'])('date-time-picker-datepicker'), validTime);
                ...
                click((0, _emberTestSelectors['default'])('publishmenu-trigger'));
                ...
                // Publish the post
                click((0, _emberTestSelectors['default'])('publishmenu-save'));
                ...
                datepickerSelect((0, _emberTestSelectors['default'])('date-time-picker-datepicker'), (0, _moment['default'])('2016-05-10 10:00'));
                fillIn((0, _emberTestSelectors['default'])('date-time-picker-time-input'), '10:00');
                triggerEvent((0, _emberTestSelectors['default'])('date-time-picker-time-input'), 'blur');
                // saving
                click((0, _emberTestSelectors['default'])('publishmenu-trigger'));
                click((0, _emberTestSelectors['default'])('publishmenu-save'));
                ...
                // unpublish
                click((0, _emberTestSelectors['default'])('publishmenu-trigger'));
                click((0, _emberTestSelectors['default'])('publishmenu-unpublished-option'));
                click((0, _emberTestSelectors['default'])('publishmenu-save'));
                ...
                // schedule post
                click((0, _emberTestSelectors['default'])('publishmenu-cancel'));
                click((0, _emberTestSelectors['default'])('publishmenu-trigger'));

                var newFutureTime = _moment['default'].tz('Pacific/Kwajalein').add(10, 'minutes');
                click((0, _emberTestSelectors['default'])('publishmenu-scheduled-option'));
                datepickerSelect((0, _emberTestSelectors['default'])('publishmenu-draft') + ' ' + (0, _emberTestSelectors['default'])('date-time-picker-datepicker'), newFutureTime);
                click((0, _emberTestSelectors['default'])('publishmenu-save'));
                click((0, _emberTestSelectors['default'])('publishmenu-cancel'));
                ...
                // unschedule
                click((0, _emberTestSelectors['default'])('publishmenu-trigger'));
                click((0, _emberTestSelectors['default'])('publishmenu-draft-option'));
                click((0, _emberTestSelectors['default'])('publishmenu-save'));
                click((0, _emberTestSelectors['default'])('publishmenu-cancel'));
            ...
            (0, _mocha.it)('handles validation errors when scheduling', function () {
                ...
                var plusTenMin = (0, _moment['default'])().utc().add(10, 'minutes');

                visit('/editor/' + post.id);

                click((0, _emberTestSelectors['default'])('publishmenu-trigger'));
                click((0, _emberTestSelectors['default'])('publishmenu-scheduled-option'));
                datepickerSelect((0, _emberTestSelectors['default'])('publishmenu-draft') + ' ' + (0, _emberTestSelectors['default'])('date-time-picker-datepicker'), plusTenMin);
                fillIn((0, _emberTestSelectors['default'])('publishmenu-draft') + ' ' + (0, _emberTestSelectors['default'])('date-time-picker-time-input'), plusTenMin.format('HH:mm'));
                triggerEvent((0, _emberTestSelectors['default'])('publishmenu-draft') + ' ' + (0, _emberTestSelectors['default'])('date-time-picker-time-input'), 'blur');
                click((0, _emberTestSelectors['default'])('publishmenu-save'));
            ...
            (0, _mocha.it)('handles title validation errors correctly', function () {
                ...
                andThen(function () {
                    (0, _ghostAdminTestsHelpersEditorHelpers.titleRendered)();
                });

                andThen(function () {
                    var title = find('#gh-editor-title div');
            ...
            (0, _mocha.it)('if title is blank it correctly shows the placeholder', function () {
                server.createList('post', 1);
                ...
                andThen(function () {
                    var title = find('#gh-editor-title div');
                    (0, _chai.expect)(title.data('placeholder')).to.equal('Your Post Title');
                    (0, _chai.expect)(title.hasClass('no-content')).to.be['false'];
                    title.html('');
                });

                andThen(function () {
                    var title = find('#gh-editor-title div');
                    (0, _chai.expect)(title.hasClass('no-content')).to.be['true'];
                    title.html('test');
                });
            ...
            (0, _mocha.it)('renders first countdown notification before scheduled time', function () {
                var clock = _sinon['default'].useFakeTimers((0, _moment['default'])().valueOf());
                var compareDate = (0, _moment['default'])().tz('Etc/UTC').add(4, 'minutes');
                var compareDateString = compareDate.format('MM/DD/YYYY');
                var compareTimeString = compareDate.format('HH:mm');
    ...
    (0, _mocha.describe)('Acceptance: Settings - General', function () {
        ...
        (0, _mocha.describe)('when logged in', function () {
            ...
            (0, _mocha.it)('it renders, shows image uploader modals', function () {
                ...
                andThen(function () {
                    (0, _chai.expect)(find((0, _emberTestSelectors['default'])('file-input-description')).text()).to.equal('Upload an image');
                });
...
define('ghost-admin/tests/acceptance/setup-test', ['exports', 'mocha', 'chai', 'ghost-admin/tests/helpers/start-app', 'ghost-admin/tests/helpers/destroy-app', 'ghost-admin/tests/helpers/ember-simple-auth', 'ghost-admin/tests/helpers/configuration', 'ember-cli-mirage', 'ghost-admin/tests/helpers/oauth', 'moment'], function (exports, _mocha, _chai, _ghostAdminTestsHelpersStartApp, _ghostAdminTestsHelpersDestroyApp, _ghostAdminTestsHelpersEmberSimpleAuth, _ghostAdminTestsHelpersConfiguration, _emberCliMirage, _ghostAdminTestsHelpersOauth, _moment) {
    var _slicedToArray = (function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i['return']) _i['return'](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError('Invalid attempt to destructure non-iterable instance'); } }; })();
...
define('ghost-admin/tests/acceptance/team-test', ['exports', 'mocha', 'chai', 'ghost-admin/tests/helpers/start-app', 'ghost-admin/tests/helpers/destroy-app', 'ghost-admin/tests/helpers/ember-simple-auth', 'ghost-admin/tests/helpers/adapter-error', 'ghost-admin/tests/helpers/configuration', 'ember-cli-mirage', 'ember-test-selectors', 'moment'], function (exports, _mocha, _chai, _ghostAdminTestsHelpersStartApp, _ghostAdminTestsHelpersDestroyApp, _ghostAdminTestsHelpersEmberSimpleAuth, _ghostAdminTestsHelpersAdapterError, _ghostAdminTestsHelpersConfiguration, _emberCliMirage, _emberTestSelectors, _moment) {
    var _slicedToArray = (function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i['return']) _i['return'](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError('Invalid attempt to destructure non-iterable instance'); } }; })();
...
define('ghost-admin/tests/acceptance/version-mismatch-test', ['exports', 'mocha', 'chai', 'ghost-admin/tests/helpers/start-app', 'ghost-admin/tests/helpers/destroy-app', 'ghost-admin/tests/helpers/ember-simple-auth', 'ghost-admin/mirage/utils', 'ember-test-selectors'], function (exports, _mocha, _chai, _ghostAdminTestsHelpersStartApp, _ghostAdminTestsHelpersDestroyApp, _ghostAdminTestsHelpersEmberSimpleAuth, _ghostAdminMirageUtils, _emberTestSelectors) {
    ...
    (0, _mocha.describe)('Acceptance: Version Mismatch', function () {
        ...
        (0, _mocha.describe)('logged in', function () {
            ...
            (0, _mocha.it)('displays an alert and disables navigation when saving', function () {
                ...
                click((0, _emberTestSelectors['default'])('publishmenu-trigger'));
                click((0, _emberTestSelectors['default'])('publishmenu-save')); // "Save post"
...
define('ghost-admin/tests/authenticators/oauth2-ghost.lint-test', ['exports'], function (exports) {
  ...
  describe('ESLint - authenticators/oauth2-ghost-02f0bed201803c2dc2c17cdac9b78f8a.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/components/gh-basic-dropdown.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/gh-basic-dropdown.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/components/gh-date-time-picker.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/gh-date-time-picker.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/components/gh-editor-post-status.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/gh-editor-post-status.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('ghost-admin/tests/components/gh-editor-title.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/gh-editor-title.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/components/gh-publishmenu-draft.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/gh-publishmenu-draft.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('ghost-admin/tests/components/gh-publishmenu-published.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/gh-publishmenu-published.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('ghost-admin/tests/components/gh-publishmenu-scheduled.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/gh-publishmenu-scheduled.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('ghost-admin/tests/components/gh-publishmenu.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/gh-publishmenu.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/components/power-select/trigger.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/power-select/trigger.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/helpers/editor-helpers', ['exports', 'ember', 'jquery'], function (exports, _ember, _jquery) {
    ...
    exports.testInputTimeout = testInputTimeout;
    ...
    function titleRendered() {
        return _ember['default'].Test.promise(function (resolve) {
            // eslint-disable-line
            function checkTitle() {
                var title = (0, _jquery['default'])('#gh-editor-title div');
                if (title[0]) {
                    return resolve();
                } else {
    ...
    function testInputTimeout(input) {
...
define('ghost-admin/tests/helpers/ember-basic-dropdown', ['exports', 'ember', 'ember-runloop', 'jquery', 'ember-native-dom-helpers'], function (exports, _ember, _emberRunloop, _jquery, _emberNativeDomHelpers) {
...
define('ghost-admin/tests/helpers/ember-power-calendar', ['exports', 'ember-test', 'ember-runloop', 'ember-metal/utils', 'moment'], function (exports, _emberTest, _emberRunloop, _emberMetalUtils, _moment) {
  ...
  function findComponentInstance(app, selector) {
    ...
    (0, _emberMetalUtils.assert)('Could not find a calendar using selector: "' + selector + '"', calendarGuid);
  ...
  exports['default'] = function () {
    _emberTest['default'].registerAsyncHelper('calendarCenter', function (app, selector, newCenter) {
      (0, _emberMetalUtils.assert)('`calendarCenter` expect a Date or MomentJS object as second argument', newCenter);
      var calendarComponent = findComponentInstance(app, selector);
      var onCenterChange = calendarComponent.get('onCenterChange');
      (0, _emberMetalUtils.assert)('You cannot call `calendarCenter` on a component that doesn\'t has an `onCenterChange` action', !!onCenterChange);
    ...
    _emberTest['default'].registerAsyncHelper('calendarSelect', function (app, selector, selected) {
      (0, _emberMetalUtils.assert)('`calendarSelect` expect a Date or MomentJS object as second argument', selected);
...
define('ghost-admin/tests/helpers/ember-power-datepicker', ['exports', 'ember-test', 'ember-metal/utils', 'ghost-admin/tests/helpers/ember-basic-dropdown', 'ghost-admin/tests/helpers/ember-power-calendar'], function (exports, _emberTest, _emberMetalUtils, _ghostAdminTestsHelpersEmberBasicDropdown, _ghostAdminTestsHelpersEmberPowerCalendar) {
  exports['default'] = function () {
    (0, _ghostAdminTestsHelpersEmberBasicDropdown['default'])();
    (0, _ghostAdminTestsHelpersEmberPowerCalendar['default'])();

    _emberTest['default'].registerAsyncHelper('datepickerSelect', function (app, selector, selected) {
      (0, _emberMetalUtils.assert)('`datepickerSelect` expect a Date or MomentJS object as second argument', selected);
      var $selector = find(selector);
      (0, _emberMetalUtils.assert)('`datepickerSelect` couln\'t find any element with selector: ' + selector, $selector.length);
      var $trigger = undefined;
      if ($selector.hasClass('ember-power-datepicker-trigger')) {
        $trigger = $selector;
      } else {
        $trigger = find(selector + ' .ember-power-datepicker-trigger');
        (0, _emberMetalUtils.assert)('`datepickerSelect` couln\'t find any datepicker within the selector ' + selector, $trigger.length);
...
define('ghost-admin/tests/helpers/ember-power-select', ['exports', 'ember-test', 'ember-native-dom-helpers/test-support/helpers'], function (exports, _emberTest, _emberNativeDomHelpersTestSupportHelpers) {
  ...
  function findContains(selector, text) {
    return [].slice.apply((0, _emberNativeDomHelpersTestSupportHelpers.findAll)(selector)).filter(function (e) {
      return e.textContent.trim().indexOf(text) > -1;
    })[0];
  }

  function nativeMouseDown(selectorOrDomElement, options) {
    (0, _emberNativeDomHelpersTestSupportHelpers.triggerEvent)(selectorOrDomElement, 'mousedown', options);
  }

  function nativeMouseUp(selectorOrDomElement, options) {
    (0, _emberNativeDomHelpersTestSupportHelpers.triggerEvent)(selectorOrDomElement, 'mouseup', options);
  }

  function triggerKeydown(domElement, k) {
    (0, _emberNativeDomHelpersTestSupportHelpers.keyEvent)(domElement, 'keydown', k);
  }
  ...
  function nativeTouch(selectorOrDomElement) {
    (0, _emberNativeDomHelpersTestSupportHelpers.triggerEvent)(selectorOrDomElement, 'touchstart');
    (0, _emberNativeDomHelpersTestSupportHelpers.triggerEvent)(selectorOrDomElement, 'touchend');
  }
  ...
  exports['default'] = function () {
    _emberTest['default'].registerAsyncHelper('selectChoose', function (app, cssPath, valueOrSelector) {
      ...
      andThen(function () {
        var potentialTargets = find('#' + contentId + ' .ember-power-select-option:contains("' + valueOrSelector + '")').toArray();
    ...
    _emberTest['default'].registerAsyncHelper('selectSearch', function (app, cssPath, value) {
      ...
      var contentId = '' + $trigger.attr('aria-owns');
      var isMultipleSelect = find(cssPath + ' .ember-power-select-trigger-multiple-input').length > 0;
      ...
      var isDefaultSingleSelect = find('.ember-power-select-search-input').length > 0;
...
define('ghost-admin/tests/helpers/start-app', ['exports', 'ember-platform', 'ember-runloop', 'ghost-admin/app', 'ghost-admin/config/environment', 'ghost-admin/tests/helpers/ember-power-select', 'ghost-admin/tests/helpers/ember-power-datepicker', 'ghost-admin/tests/helpers/file-upload'], function (exports, _emberPlatform, _emberRunloop, _ghostAdminApp, _ghostAdminConfigEnvironment, _ghostAdminTestsHelpersEmberPowerSelect, _ghostAdminTestsHelpersEmberPowerDatepicker, _ghostAdminTestsHelpersFileUpload) {
    ...
    function startApp(attrs) {
        ...
        return (0, _emberRunloop['default'])(function () {
            var application = _ghostAdminApp['default'].create(attributes);
...
define('ghost-admin/tests/integration/components/gh-basic-dropdown-test', ['exports', 'chai', 'mocha', 'ember-mocha', 'ghost-admin/tests/helpers/ember-basic-dropdown', 'ember-native-dom-helpers', 'jquery', 'ember-runloop'], function (exports, _chai, _mocha, _emberMocha, _ghostAdminTestsHelpersEmberBasicDropdown, _emberNativeDomHelpers, _jquery, _emberRunloop) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-basic-dropdown', function () {
        ...
        (0, _mocha.it)('closes when dropdown service fires close event', function () {
            ...
            this.render(Ember.HTMLBars.template({
                'id': 'a43kF/aV',
                'block': '{"statements":[["text","\\n"],["block",["gh-basic-dropdown"],null,null,1],["text","        "]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","                    "],["open-element","div",[]],["static-attr","id","dropdown-is-opened"],["flush-element"],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","                "],["open-element","button",[]],["static-attr","class","ember-basic-dropdown-trigger"],["dynamic-attr","onclick",["unknown",["dropdown","actions","toggle"]],null],["flush-element"],["close-element"],["text","\\n"],["block",["if"],[["get",["dropdown","isOpen"]]],null,0]],"locals":["dropdown"]}],"hasPartials":false}',
                'meta': {}
            }));

            (0, _ghostAdminTestsHelpersEmberBasicDropdown.clickTrigger)();
...
define('ghost-admin/tests/integration/components/gh-basic-dropdown-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/gh-basic-dropdown-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/integration/components/gh-date-time-picker-test', ['exports', 'chai', 'mocha', 'ember-mocha'], function (exports, _chai, _mocha, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-date-time-picker', function () {
        ...
        _mocha.it.skip('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                'id': 'hL23KHqg',
                'block': '{"statements":[["append",["unknown",["gh-date-time-picker"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            }));
...
define('ghost-admin/tests/integration/components/gh-date-time-picker-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/gh-date-time-picker-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('ghost-admin/tests/integration/components/gh-editor-post-status-test', ['exports', 'chai', 'mocha', 'ember-mocha'], function (exports, _chai, _mocha, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-editor-post-status', function () {
        ...
        (0, _mocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                'id': 'NHOOLMcX',
                'block': '{"statements":[["append",["unknown",["gh-editor-post-status"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            }));
            (0, _chai.expect)(this.$()).to.have.length(1);
        });
...
define('ghost-admin/tests/integration/components/gh-editor-post-status-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/gh-editor-post-status-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/integration/components/gh-image-uploader-test', ['exports', 'sinon', 'chai', 'mocha', 'ember-mocha', 'pretender', 'ember-test-helpers/wait', 'ghost-admin/tests/helpers/file-upload', 'jquery', 'ember-runloop', 'ember-service', 'ghost-admin/services/ajax', 'ember-test-selectors'], function (exports, _sinon, _chai, _mocha, _emberMocha, _pretender, _emberTestHelpersWait, _ghostAdminTestsHelpersFileUpload, _jquery, _emberRunloop, _emberService, _ghostAdminServicesAjax, _emberTestSelectors) {
    var _slicedToArray = (function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i['return']) _i['return'](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError('Invalid attempt to destructure non-iterable instance'); } }; })();
...
define('ghost-admin/tests/integration/components/gh-koenig-markdown-test', ['exports', 'chai', 'mocha', 'ember-mocha', 'ghost-admin/tests/helpers/editor-helpers'], function (exports, _chai, _mocha, _emberMocha, _ghostAdminTestsHelpersEditorHelpers) {

    (0, _mocha.describe)('Integration: Component: gh-koenig', function () {
        ...
        (0, _mocha.describe)('Makerable markdown support.', function () {
            (0, _mocha.it)('plain text inputs (placebo)', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
                }));
            ...
            // bold
            (0, _mocha.it)('** bolds at start of line', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            (0, _mocha.it)('** bolds in a line', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            (0, _mocha.it)('__ bolds at start of line', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            (0, _mocha.it)('__ bolds in a line', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            // italic
            (0, _mocha.it)('* italicises at start of line', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            (0, _mocha.it)('* italicises in a line', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            (0, _mocha.it)('_ italicises at start of line', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            (0, _mocha.it)('_ italicises in a line', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            // strikethrough
            (0, _mocha.it)('~~ strikethroughs at start of line', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            (0, _mocha.it)('~~ strikethroughs in a line', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            // links
            (0, _mocha.it)('[]() creates a link at start of line', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            (0, _mocha.it)('[]() creates a link in a line', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
        ...
        (0, _mocha.describe)('Block markdown support', function () {
            ...
            // headings
            (0, _mocha.it)('# creates an H1', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            (0, _mocha.it)('## creates an H2', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            (0, _mocha.it)('### creates an H3', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            // lists
            (0, _mocha.it)('* creates an UL', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            (0, _mocha.it)('1. creates an OL', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
            ...
            // quote
            (0, _mocha.it)('> creates an blockquote', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
        ...
        (0, _mocha.describe)('Card markdown support.', function () {
            (0, _mocha.it)('![]() creates an image card', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
                ...
                (0, _ghostAdminTestsHelpersEditorHelpers.editorRendered)().then(function () {
                    ...
                    editor.element.focus();
                    return (0, _ghostAdminTestsHelpersEditorHelpers.testInputTimeout)('![image of something](https://unsplash.it/200/300/?random)');
                }).then(function (value) {
                    (0, _chai.expect)(value).to.have.string('kg-card-image');
                    done();
                });
            });
            (0, _mocha.it)('``` creates a markdown card.', function (done) {
                this.render(Ember.HTMLBars.template({
                    'id': 'cKUgb2dz',
                    'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                    'meta': {}
                ...
                (0, _ghostAdminTestsHelpersEditorHelpers.editorRendered)().then(function () {
                    ...
                    editor.element.focus();
                    return (0, _ghostAdminTestsHelpersEditorHelpers.testInputTimeout)('```some code```');
                }).then(function (value) {
                    (0, _chai.expect)(value).to.have.string('kg-card-markdown');
                    done();
                });
            });
        });
...
/* jshint expr:true */
define('ghost-admin/tests/integration/components/gh-koenig-markdown-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/gh-koenig-markdown-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/integration/components/gh-koenig-slashmenu-test', ['exports', 'chai', 'mocha', 'ember-mocha', 'ghost-admin/tests/helpers/editor-helpers', 'jquery'], function (exports, _chai, _mocha, _emberMocha, _ghostAdminTestsHelpersEditorHelpers, _jquery) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-koenig-slashmenu', function () {
        (0, _emberMocha.setupComponentTest)('gh-koenig', {
            integration: true
        });
        beforeEach(function () {
        ...
        (0, _mocha.it)('the slash menu appears on user input', function (done) {
            this.render(Ember.HTMLBars.template({
                'id': 'cKUgb2dz',
                'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
        ...
        (0, _mocha.it)('searches when a user types', function (done) {
            this.render(Ember.HTMLBars.template({
                'id': 'cKUgb2dz',
                'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value"],["/todo","/assets",".editor-holder",["get",["value"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            ...
            (0, _ghostAdminTestsHelpersEditorHelpers.editorRendered)().then(function () {
                ...
                var cardMenu = (0, _jquery['default'])('.gh-cardmenu');
                (0, _chai.expect)(cardMenu.children().length).to.equal(7);
                (0, _ghostAdminTestsHelpersEditorHelpers.inputText)(editor, ' bul');
                return (0, _ghostAdminTestsHelpersEditorHelpers.timeoutPromise)(500);
            }).then(function () {
                var cardMenu = (0, _jquery['default'])('.gh-cardmenu');
        ...
        _mocha.it.skip('ul tool', function (done) {
            this.set('editorMenuIsOpen', function () {});
            this.set('editorMenuIsClosed', function () {});

            this.render(Ember.HTMLBars.template({
                'id': '4yOmgwTJ',
                'block': '{"statements":[["append",["helper",["gh-koenig"],null,[["apiRoot","assetPath","containerSelector","value","menuIsOpen","menuIsClosed"],["/todo","/assets",".editor-holder",["get",["value"]],["get",["editorMenuIsOpen"]],["get",["editorMenuIsClosed"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            }));
            ...
            (0, _ghostAdminTestsHelpersEditorHelpers.editorRendered)().then(function () {
                ...
                (0, _jquery['default'])('.gh-cardmenu-card').click();
                done();
            });
            // .then(() => {
            //
...
define('ghost-admin/tests/integration/components/gh-navigation-test', ['exports', 'chai', 'mocha', 'ember-mocha', 'jquery', 'ember-runloop', 'ghost-admin/models/navigation-item', 'ember-test-helpers/wait'], function (exports, _chai, _mocha, _emberMocha, _jquery, _emberRunloop, _ghostAdminModelsNavigationItem, _emberTestHelpersWait) {
...
define('ghost-admin/tests/integration/components/gh-publishmenu-draft-test', ['exports', 'chai', 'mocha', 'ember-mocha'], function (exports, _chai, _mocha, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-publishmenu-draft', function () {
        ...
        _mocha.it.skip('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                'id': '2mtKGgvP',
                'block': '{"statements":[["append",["unknown",["gh-publishmenu-draft"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            }));
            (0, _chai.expect)(this.$()).to.have.length(1);
        });
...
define('ghost-admin/tests/integration/components/gh-publishmenu-draft-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/gh-publishmenu-draft-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('ghost-admin/tests/integration/components/gh-publishmenu-published-test', ['exports', 'chai', 'mocha', 'ember-mocha'], function (exports, _chai, _mocha, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-publishmenu-published', function () {
        ...
        _mocha.it.skip('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                'id': 'kd8BYHIR',
                'block': '{"statements":[["append",["unknown",["gh-publishmenu-published"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            }));
            (0, _chai.expect)(this.$()).to.have.length(1);
        });
...
define('ghost-admin/tests/integration/components/gh-publishmenu-published-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/gh-publishmenu-published-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('ghost-admin/tests/integration/components/gh-publishmenu-scheduled-test', ['exports', 'chai', 'mocha', 'ember-mocha'], function (exports, _chai, _mocha, _emberMocha) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-publishmenu-scheduled', function () {
        ...
        _mocha.it.skip('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                'id': '/ikEH53V',
                'block': '{"statements":[["append",["unknown",["gh-publishmenu-scheduled"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            }));
            (0, _chai.expect)(this.$()).to.have.length(1);
        });
...
define('ghost-admin/tests/integration/components/gh-publishmenu-scheduled-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/gh-publishmenu-scheduled-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('ghost-admin/tests/integration/components/gh-publishmenu-test', ['exports', 'chai', 'mocha', 'ember-mocha', 'ghost-admin/initializers/ember-cli-mirage'], function (exports, _chai, _mocha, _emberMocha, _ghostAdminInitializersEmberCliMirage) {
    ...
    (0, _mocha.describe)('Integration: Component: gh-publishmenu', function () {
        ...
        beforeEach(function () {
            server = (0, _ghostAdminInitializersEmberCliMirage.startMirage)();
            server.loadFixtures();
        ...
        (0, _mocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template({
                'id': 'fhItcng9',
                'block': '{"statements":[["append",["helper",["gh-publishmenu"],null,[["post"],[["get",["post"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                'meta': {}
            }));
            (0, _chai.expect)(this.$()).to.have.length(1);
        });
...
define('ghost-admin/tests/integration/components/gh-publishmenu-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - integration/components/gh-publishmenu-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/services/settings.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - services/settings.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/unit/components/gh-url-preview-test', ['exports', 'mocha', 'ember-mocha'], function (exports, _mocha, _emberMocha) {
...
define('ghost-admin/tests/unit/components/gh-url-preview-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - unit/components/gh-url-preview-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/unit/helpers/gh-format-timeago-test', ['exports', 'chai', 'mocha', 'ghost-admin/helpers/gh-format-timeago', 'sinon', 'moment'], function (exports, _chai, _mocha, _ghostAdminHelpersGhFormatTimeago, _sinon, _moment) {
...
define('ghost-admin/tests/unit/mixins/editor-base-controller-test', ['exports', 'chai', 'mocha', 'ember-object', 'rsvp', 'ember-runloop', 'ember-concurrency', 'ghost-admin/mixins/editor-base-controller', 'ember-test-helpers/wait'], function (exports, _chai, _mocha, _emberObject, _rsvp, _emberRunloop, _emberConcurrency, _ghostAdminMixinsEditorBaseController, _emberTestHelpersWait) {
    ...
    (0, _mocha.describe)('Unit: Mixin: editor-base-controller', function () {
        (0, _mocha.describe)('generateSlug', function () {
            (0, _mocha.it)('should generate a slug and set it on the model', function (done) {
                ...
                (0, _emberRunloop['default'])(function () {
                    object = _emberObject['default'].extend(_ghostAdminMixinsEditorBaseController['default'], {
                        slugGenerator: _emberObject['default'].create({
                            generateSlug: function generateSlug(slugType, str) {
            ...
            (0, _mocha.it)('should invoke generateSlug if the post is new and a title has not been set', function (done) {
                ...
                (0, _emberRunloop['default'])(function () {
                    object = _emberObject['default'].extend(_ghostAdminMixinsEditorBaseController['default'], {
                        ...
                        generateSlug: (0, _emberConcurrency.task)(regeneratorRuntime.mark(function callee$4$0() {
...
define('ghost-admin/tests/unit/serializers/user-test', ['exports', 'chai', 'mocha', 'ember-mocha'], function (exports, _chai, _mocha, _emberMocha) {
    ...
    (0, _mocha.describe)('Unit: Serializer: user', function () {
        (0, _emberMocha.setupModelTest)('user', {
            // Specify the other units that are required for this test.
            needs: ['model:role', 'service:ajax', 'service:ghostPaths', 'service:notifications', 'service:session', 'transform:facebook-url-user', 'transform:moment-utc', 'transform:raw', 'transform:twitter-url-user']
        });
...
//# sourceMappingURL=tests-dd16e36a1626be39494af9fecbc87945.map
